...
public class UserServiceTests {
	...
	public void getMeShouldReturnUserDTOWhenUserAuthenticated() {
		...
		UserService spyUserService = Mockito.spy(service); // metodo abaixo nao e um mock entao deve utilizar o spy
	...
	public void getMeShouldThrowUsernameNotFoundExceptionWhenUserNotAuthenticated() {
		...
		UserService spyUserService = Mockito.spy(service); // metodo abaixo nao e um mock entao deve utilizar o spy
		Mockito.doThrow(UsernameNotFoundException.class).when(spyUserService).authenticated();  //Deve retornar uma Exceção
